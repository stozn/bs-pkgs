...
onTimeDo(0, 0, 0, () => {
    ...
    if [1, 10, 15, 20, 25, 30].includes(N) then {
        if !bmd then drrr.descr(sample(ywz) + "“黩翋砬柆”祭(durarara祭)到啦！开放抽签|献礼功能24小时w  今天" + ["周日！", "周一", "周二", "周三", "周四", "周五", "周六"][mydate.getDay()] + ".night")
        later 1000 drrr.print("🔔🔔🔔 12点的钟声已经响起，一天悄无声息的过去变为昨日，欢迎来到" + M + "月" + N + "日！");
        later 2000 drrr.print("“黩翋砬柆(durarara祭)”开始啦！开放抽签|献礼功能24小时w")
    }
  else  {
        if !bmd then drrr.descr(sample(ywz) + "今天" + ["周日！", "周一", "周二", "周三", "周四", "周五", "周六"][mydate.getDay()] + ".night")
        later 1000 drrr.print("🔔🔔🔔 12点的钟声已经响起，一天悄无声息的过去变为昨日，欢迎来到" + M + "月" + N + "日！")
    }
})
